...
<head>
  ...
  <link rel="stylesheet" href="${ctx}/resources/css/summernote-lite.css"/>
  <style type="text/css">
    #bbs table {
      width:580px;
      margin-left:10px;
...
<div id="bbs">
  <form action="write" method="post"
    ...
    <table summary="게시판 글쓰기">
      ...
      <tr>
        <td colspan="2">
          <input type="button" id=write value="보내기"/>
...
<script src="${ctx}/resources/js/summernote-lite.js"></script>
<script src="${ctx}/resources/js/lang/summernote-ko-KR.js"></script>
<script>
  $(function (){
  ...
  function sendImg(file, editor) {
    ...
    $.ajax({
      ...
      $("#content").summernote("editor.insertImage", res.url);
    });
  }
</script>
</body>
