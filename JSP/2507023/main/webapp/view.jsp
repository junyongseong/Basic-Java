...
<div id="bbs">
  <form method="post" >
    <table summary="게시판 글쓰기">
      ...
      <tr>
        <th>첨부파일:</th>
        <td><a href="bbs_upload/${vo.file_name}">
        </a></td>
      </tr>
...
<script>
  ...
  function goEdit() {
    let b_idx = document.ff.b_idx.value;
    let cPage = document.ff.cPage.value;
    location.href = "Controller?type=edit&b_idx=" + b_idx + "&cPage=" + cPage;
  }
